...
default['rabbitmq']['esl-erlang_package'] = 'esl-erlang-compat-21.2.6-1.noarch.rpm?raw=true'
...
default['rabbitmq']['clustering']['cluster_name'] = 'axon-rabbitmq'
...
default['rabbitmq']['ssl_cacert'] = '/etc/certs/ca_certificate.pem'
default['rabbitmq']['ssl_cert'] = '/etc/certs/server_certificate.pem'
default['rabbitmq']['ssl_key'] = '/etc/certs/server_key.pem'
...
default['rabbitmq']['management']['load_definitions'] = true
